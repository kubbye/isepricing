    ...
    <tr> 
      <td>
	    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
          <tr> 
            <td class="titleorange"><div align="center">Add a New 3rd Party</div></td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
          </tr>
          <tr> 
            <td valign="top">
			<form action="party_add_submit.asp">
<table width="100%" border="1" bordercolordark="#FFFFFF" bordercolorlight="#CCCCCC" cellspacing="0" cellpadding="0" >
                ...
                <tr class="line01">
                  ...
                  <td><div align="left">
                      <input type="text" name="unitcostrmb">
                    </div></td>
                  <td><div align="left">Applicable Modality</div></td>
                  <td><div align="left"><input type="text" name="model"></div></td>
                </tr>
                <tr class="line01">
                  <td height="25">
					<div align="left">Lead Time</div></td>
                  <td><div align="left">
                      <input type="text" name="diliverydate">
                    </div></td>
                  <td><div align="left">Original Country</div></td>
                  <td><div align="left"><input type="text" name="madein"></div></td>
                </tr>
                <tr class="line01">
                  <td height="25">
