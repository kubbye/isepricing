  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      <td><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
          <tr> 
            <td class="titleorange"><div align="center">Add Configuration</div></td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
          </tr>
          <tr> 
            <td>
			  <form name="form1" method="post" action="configuration_add_submit.asp" onsubmit="return checkfield();">
                ...
                <tr class="line01"> 
                  ...
                  <td> <div align="left"> 
                      <select name="state">
						...
						%>
							<option VALUE="<%=i%>"><%=CONFIGURATION_STATE_DISPLAY(i)%></option>
						<%
						Next 
						%>
                      </select>
