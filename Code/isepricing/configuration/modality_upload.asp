...
<script type="text/javascript">
   function importData(){
	...
	f.action="modality_upload_submit.asp";
	f.submit();
 }
</script>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      <td><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
          <tr> 
            <td class="titleorange"><div align="center">Upload Modality</div></td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
          </tr>
			  ...
			  <table width="100%" border="1" bordercolordark="#FFFFFF" bordercolorlight="#CCCCCC" cellspacing="0" cellpadding="0" >
                <tr class="line01"> 
				  ...
				  <td>
					...
					<input type="button" name="mould" value="Template" onclick="location.href='../mould/modality_template.xlsx'"/>
				  </td>
                </tr>
              </table>
              </form>
