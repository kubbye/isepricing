...
<script type="text/javascript">
   function importData(){
	...
	f.action="party_upload_submit.asp";
	f.submit();
 }
</script>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      <td><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
          <tr> 
            <td class="titleorange"><div align="center">Upload 3<sup>rd</sup> Party Products</div></td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
          </tr>
			  ...
			  <table width="100%" border="1" bordercolordark="#FFFFFF" bordercolorlight="#CCCCCC" cellspacing="0" cellpadding="0" >
                <tr class="line01"> 
				  ...
				  <td>
					...
					<input type="button" name="mould" value="Template" onclick="location.href='../mould/3rd party_template.xlsx'"/>
				  </td>
                </tr>
              </table>
              </form>
