...
//addLink("demo-top", "Home", "", "", "l1");
addSubMenu("demo-top", "Tool Scripts", "", "", "tool-sub", "s1");
addSubMenu("demo-top", "Game Scripts", "", "", "game-sub", "s2");
addSubMenu("demo-top", "User Forum", "", "", "forum-sub", "s3");
addLink("demo-top", "Contact", "", "", "l2");
...
addLink("menu-sub", "Menu G6", "", "", "");
addLink("menu-sub", "Menu G7", "", "", "");
addLink("menu-sub", "Menu G8", "", "", "");
addLink("menu-sub", "Menu G9", "", "", "");
addLink("menu-sub", "Menu G11", "", "", "");
addLink("menu-sub", "Menu G12", "", "", "");
