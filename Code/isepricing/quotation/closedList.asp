...
<% 
	...
	If roleid="1" Or roleid="3" Or roleid="4" Or roleid="6" Or roleid="11" Or roleid="12" Or roleid="14" Or roleid="5" Or roleid="8" Then
		isshowbu=true
	End If
	strSql="select a.*,c.status spstatuc,b.username crtusername,(select username from userinfo where id=a.updtuser) updtusername from quotation a left join special_price c on c.quotationno=a.quotationno left join userinfo b on a.crtuser=b.id  where ( a.status=13) "   '2:已删除
   ...
   <tr> 
     ...
     <tr> 
      <td><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
          <tr> 
            <td class="titleorange"><div align="center">Closed Quotation List </div></td>
          </tr>
          <tr> 
...
<script>
    ...
    document.forms[0].action="closedList.asp?page="+str;
